package net.hernandomontoya.borutoapp.data.paging_source

import androidx.paging.PagingSource
import kotlinx.coroutines.ExperimentalCoroutinesApi
import kotlinx.coroutines.test.runBlockingTest
import net.hernandomontoya.borutoapp.data.remote.BorutoApi
import net.hernandomontoya.borutoapp.data.remote.FakeBorutoApi
...
class SearchHeroesSourceTest {
    ...
    fun `Search api with non existing hero name, assert empty heroes list and LoadResult_Page`() =
        runBlockingTest {
            ...
            val result = borutoApi.searchHeroes("cumbio").heroes
