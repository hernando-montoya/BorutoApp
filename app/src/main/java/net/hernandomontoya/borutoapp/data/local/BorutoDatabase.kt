...
import net.hernandomontoya.borutoapp.data.local.dao.HeroDao
import net.hernandomontoya.borutoapp.data.local.dao.HeroRemoteKeysDao
import net.hernandomontoya.borutoapp.domain.model.Hero
import net.hernandomontoya.borutoapp.domain.model.HeroRemoteKeys
    ...
    companion object {
        fun create(context: Context, useInMemory: Boolean): BorutoDatabase {
            val databaseBuilder = if (useInMemory) {
                ...
                Room.databaseBuilder(context, BorutoDatabase::class.java, "test_databse.db")
            }
